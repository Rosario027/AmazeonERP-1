...
export default function AdminCustomers() {
  ...
  // Requirements list for admin fulfillment
  ...
  const filteredAndSortedRequirements = requirements
    ...
    .sort((a, b) => {
      if (!!a.requirementsFulfilled !== !!b.requirementsFulfilled) {
        return a.requirementsFulfilled ? 1 : -1; // open first
      }
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <Select value={fulfillmentFilter} onValueChange={(v: any) => setFulfillmentFilter(v)}>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredAndSortedRequirements.map((req) => (
                    <TableRow key={req.id} className={req.requirementsFulfilled ? "bg-muted/30 opacity-70" : ""}>
                      <TableCell>
                      ...
                      <TableCell className="text-center">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            toggleFulfillmentMutation.mutate({ invoiceId: req.id, fulfilled: !!checked })
                          }
